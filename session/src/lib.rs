...
//!
//! [`SessionMiddleware`] is the middleware that takes care of all the session cookie handling and
//! instructs the **storage backend** to create/delete/update the session state based on the
//! operations performed against the active [`Session`].
//!
